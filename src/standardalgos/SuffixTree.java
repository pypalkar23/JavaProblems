...
class SuffixTree {
    ...
    public void extendSuffixTree(int pos) {
        ...
        while (remainingSuffixCount > 0) {
            ...
            if (activeNode == root && activeLength > 0) {
                ...
                System.out.println("through suffixLink activeNode is set to " + activeNode.start + " "
                        + activeNode.end.wrappedInt);
            }
            System.out.println("-------------------");
        }
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(tree.root.children['x'].start+"
        // "+tree.root.children['x'].end.wrappedInt);
        // System.out.println(tree.root.children[97].start+"
        // "+tree.root.children[97].end.wrappedInt);
        // System.out.println(tree.root.children[97].children['b'].start+"
        // "+tree.root.children[97].children['b'].end.wrappedInt);
        // System.out.println(tree.root.children[97].children['c'].start+"
        // "+tree.root.children[97].children['c'].end.wrappedInt);
        // System.out.println(tree.root.children[67].start+"
        // "+tree.root.children[67].end.wrappedInt);
